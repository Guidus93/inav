...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM4,  CH1,  PB6, TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_MC_SERVO, 0, 1), // S5
    DEF_TIM(TIM4,  CH2,  PB7, TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_MC_SERVO, 0, 0), // S6
    DEF_TIM(TIM8,  CH3,  PC8, TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_MC_SERVO, 0, 0), // S7
